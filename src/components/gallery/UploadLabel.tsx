...
const UploadLabel = (props: Props) => {
  ...
  return (
    <label
      htmlFor={htmlFor}
      className={`${className} bg-gray-50 flex items-center justify-center flex-col rounded-lg cursor-pointer border shadow-lg font-medium px-4 gap-y-3 h-32 hover:bg-gray-100`}
    >
